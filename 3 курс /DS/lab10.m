...
SystemOfEquations[edgesList_,vertexList_,array_,vertex_] := Block[{},
...
EquationsBalance[gArray_, gPred_, gDinastVertex_, gDir_,gEdgesList_,gTreeEdges_]:=Block[{}, 
...
characteristic[edge_,listUn_,edgesList_,depth_,pred_,vertexList_,listUt_,dir_]:=Block[{},
...
generalFunction[ij_,indepVars_,\[Delta]_,listUn_,result_,edgesList_]:=Block[{},
